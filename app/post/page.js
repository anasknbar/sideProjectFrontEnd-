...
export default function Post() {
  ...
  const handlePostForm = (e) => {
    ...
    if (tokens) {
      ...
      const user_id = decodedTokens.user_id;
      const title = e.target.elements.title.value;
      const prompt = e.target.elements.prompt.value;
      const ai_response = e.target.elements.ai_response.value;
      const destructredTags = tags.join(",");
  ...
  return (
    <>
      <div className="sm:ml-auto pl-60 pr-8 py-8 mt-14 ">
        <form onSubmit={handlePostForm} id="conversationForm">
          <div className="flex gap-x-4 ">
            {/* Post title */}
            <div class="mb-6 w-1/2">
              <label
                for="post_title"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white tracking-wide"
              >
                Title
              </label>
              <input
                ...
                id="post_title"
                name="title"
                class="w-full h-12 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          {/* parent div for prompt and ai-response */}
          <div className="flex gap-x-4 ">
            {/* Prompt textarea  */}
            <div class="w-1/2 mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 ">
              ...
              <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                <label for="prompt_editor" class="sr-only">
                  Publish post
                </label>
                <textarea
                  id="prompt_editor"
            ...
            <div class="w-1/2 mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
              ...
              <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                <label for="response_editor" class="sr-only">
                  Publish post
                </label>
                <textarea
                  id="response_editor"

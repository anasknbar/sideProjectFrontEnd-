...
export default function UserHeader() {
  ...
  return (
    <>
      ...
      {/* ------------ */}
      <nav class=" fixed top-0 left-0 w-full bg-white border-gray-200 border-b-2 dark:bg-gray-900 z-50 ">
          ...
          >
            ...
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a
                  onClick={logout}
                  class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 cursor-pointer"
                  aria-current="page"
                >
                  Log Out
                </a>
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="size-6 cursor-pointer hover:text-green-500"
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"

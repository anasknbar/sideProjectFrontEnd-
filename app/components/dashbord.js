...
export default function Dashboard() {
  ...
  if (tokens) {
    ...
    const username = decodedTokens.username;
    ...
    return (
      <>
        ...
        <aside
          ...
          class="fixed border-gray-200 border-b-2  left-0 z-40 w-56 h-screen transition-transform -translate-x-full sm:translate-x-0"
          aria-label="Sidebar"
        >
        ...
        <div class=" sm:ml-auto mt-14 ">
          <div className="h-36 bg-red-700"></div>
          <div className="h-36 bg-blue-700"></div>
          <div className="h-36 bg-red-700"></div>
          <div className="h-36 bg-blue-700"></div>
          <div className="h-36 bg-red-700"></div>
          <div className="h-36 bg-blue-700"></div>

...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* <aside
        id="separator-sidebar"
        class="fixed border-gray-200   right-5 z-40 w-60 h-120 transition-transform -translate-x-full sm:translate-x-0 mt-20 "
        aria-label="Sidebar"
      >
        <div class="h-full  pl-5 py-5 overflow-y-auto bg-gray-200 dark:bg-gray-800 border rounded-lg">
